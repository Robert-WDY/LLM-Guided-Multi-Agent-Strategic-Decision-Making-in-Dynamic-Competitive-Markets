    ...
    def advise(
        ...
        *,
        ...
        if advisor_mode in {
            ...
            if advisor_mode in {"pareto_reliable_v5", "pareto_reliable_v6"}:
        ...
        is_reliable = advisor_mode in {"pareto_reliable_v5", "pareto_reliable_v6"}
        is_marginal = advisor_mode == "pareto_reliable_v6"
