...
def main():
    ...
    write("preregistration.json", {"scope":"One hosted real-model decision and durable trace; not a profitability claim",
          "seed":210133,"maximum_calls":1,"maximum_additional_cny":0.42,"original_total_cny":10,
    ...
    episode = request("/api/episodes",{"episode_id":"stage20-real-210133","episode_seed":210133,"max_rounds":5,
        "information_mode":"public","communication_mode":"off","cooperation_mode":"combined_v1",
        "agent_configs":{"company_A":{"provider":"deepseek","agent_type":"model","model":"deepseek-v4-flash","persona_name":"balanced_v1"}}})
    state=episode["state"]; prefix="/api/v1/controller/episodes/"+state["episode_id"]
    body={"run_id":"stage20-real-one","max_rounds":1,"expected_round":state["round"],"expected_state_version":state["state_version"],
